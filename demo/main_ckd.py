...
pn.Row(pn.pane.PNG('CKD_Example_new.png', height=300)).servable(target='ckd_img')
pn.Column(*sliders, width=450).servable(target='ckd_app')
pn.Row(pn.pane.Matplotlib(pn.bind(plot, *sliders)), height=350).servable(target='ckd_plot')